<template>
	<div class="symbin-productdetail-ui">
	
		<div class="symbin-productdetail-title">
		...
		<Modal v-model="modal1" title="广告">
			...
			<div class="symbin-productdetail-addinfo">
	
				<Form ref="formItem" :model="formItem" :rules="ruleValidate" :label-width="80">
	
					<FormItem label="孵化场名称" prop="productdetailname">
	
						<Input v-model="formItem.productdetailname" placeholder="孵化场名称"></Input>
	
					</FormItem>
					<FormItem label="孵化场所在地" prop="productdetailname">
	...
	export default {
		...
		methods: {
			...
			add() { //增加
				...
				var formparams = {
					productdetailname: s.formItem.productdetailname,
				}
	
				symbinUtil.ajax({
	
					url: window.config.baseUrl + "/admin/addproductdetail",
			...
			show(index) {
				...
				s.currentIndex = s.listData[index].productdetailid;
				
				s.formItem = {
					productdetailid: s.listData[index].productdetailid,
					productdetailname: s.listData[index].productdetailname,
			...
			getListData(rak, fn) { //获取数据
				...
				symbinUtil.ajax({
					...
					url: window.config.baseUrl + "/admin/getproductdetaillist",
			...
			edit(productdetailid) { //编辑
				...
				symbinUtil.ajax({
					...
					url: window.config.baseUrl + "/admin/editproductdetail",
					validate: s.validateData,
					data: formparams,
			...
			remove(productdetail) { //删除
	
				var productdetailids = productdetail.productdetailid;
	
				var s = this;
	
				symbinUtil.ajax({
	
					url: window.config.baseUrl + "/admin/delproductdetail",
